  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/averageScore', //平均分
          component: () => import('@/components/teacher/averageScore')
        },
        {
          path: '/scorePart',
        ...
        {
          path: '/averagePart',
          component: () => import('@/components/charts/averagePart')
        },
        {
        ...
        {
          path: '/selectPractical',
          component: () => import('@/components/teacher/selectPractical')
        },
        {
        ...
        {
          path: '/addPractical',
          component: () => import('@/components/teacher/addPractical')
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/wrong', component: () => import("@/components/student/wrong") },
        { path: '/practicalMsg', component: () => import("@/components/student/practicalMsg") },
        {
          path: '/myPractical', //添加考试
          component: () => import('@/components/student/myPractical')
        },
      ]
    },
