...
import com.examsys.oes.mapper.ScoreMapper;
import com.examsys.oes.service.ScoreService;
...
public class ScoreServiceImpl implements ScoreService {
    ...
    @Override
    public List<Score> findByExamname(String examname) {
        return scoreMapper.findByExamname(examname);
    }
}
