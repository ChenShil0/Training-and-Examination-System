...
import com.examsys.oes.service.ExamManageService;
...
public class ExamManageServiceImpl implements ExamManageService {
    ...
    @Override
    public List<ExamManage> findAlls() {
        Page<ExamManage> examManage = new Page<>(0,9999);
        List<ExamManage> examManageList = examManageMapper.findAlls(examManage).getRecords();
        setMaxScore(examManageList);
        return examManageList;
    }
