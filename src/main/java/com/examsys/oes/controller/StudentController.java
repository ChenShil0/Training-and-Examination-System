...
import com.examsys.oes.serviceimpl.StudentServiceImpl;
...
public class StudentController {
    ...
    @PutMapping("/studentwrong")
    public ApiResult updatewrong(@RequestBody Studentwrong studentwrong) {
        studentService.updatewrong(studentwrong);
        return ApiResultHandler.buildApiResult(200,"错题本更新成功",null);
    }
